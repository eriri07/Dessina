...
public class Test_1 : MonoBehaviour
{
    ...
    public int test_int;       //정수를 할당할 때 int 타입으로 변수를 선언한다.
    public float test_float;   //정수도 가능하지만 소수의 값을 저장할 때 float타입의 변수를 선언한다.
    public string test_string; //문자열을 할당해줄 때 string 타입의 변수를 선언해준다.         
...
*/
    ...
    private void Update()
    {
        ...
        //(Ctrl + K 누른 후 Ctrl + C) 이걸 풀려면 (Ctrl + K 를 누른 후 Ctrl + Ctrl + U)
